...
public:
    ...
    Co2_sensor(hal::i2c& p_i2c): m_i2c(p_i2c){
        ...
        hal::write(m_i2c, sensor_address, std::array{start_add},hal::never_timeout());
    ...
    hal::result<hal::byte> read_co2(){
        ...
        std::array<hal::byte,numBytes> buffer = hal::write_then_read(m_i2c, sensor_address, std::array{read_add})
    ...
    hal::status stop(){
        hal::write(m_i2c, sensor_address, std::array{stop_add},hal::never_timeout());
