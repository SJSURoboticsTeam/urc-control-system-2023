...
namespace sjsu::drive {
  ...
  hal::result<pwm_relay> pwm_relay::create(settings p_settings, hal::pwm& p_pwm, hal::steady_clock& p_clock)
  {
  ...
  hal::result<status_t> pwm_relay::driver_status() {
    return m_status;
  }

  hal::result<set_status_t> pwm_relay::driver_toggle(bool p_toggle) {
