...
hal::result<drive::hardware_map> initialize_target()
{
  ...
  auto& in0 = HAL_CHECK((hal::lpc40xx::input_pin::get<2, 3>())); // home_b
  auto& in1 = HAL_CHECK((hal::lpc40xx::input_pin::get<1, 26>()));  // home_a
  auto& in2 = HAL_CHECK((hal::lpc40xx::input_pin::get<1, 19>()));  // home_c
