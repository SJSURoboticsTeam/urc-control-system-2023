...
application_framework initialize_platform()
{
  ...
  static auto right_leg_drc_servo =
    hal::make_servo(right_leg_steer_drc, 5.0_rpm);
  static auto right_leg_drc_steer_speed_sensor =
    make_speed_sensor(right_leg_steer_drc);
  hal::lpc40::input_pin right_leg_mag(1, 15, hal::input_pin::settings{});

  static hal::rmd::drc right_leg_hub_drc(can_router, counter, 6.0, 0x144);
  static auto right_leg_drc_motor =
    hal::make_motor(right_leg_hub_drc, 100.0_rpm);
  static auto right_leg_drc_hub_speed_sensor =
    make_speed_sensor(right_leg_hub_drc);

  static offset_servo right_leg_drc_offset_servo(right_leg_drc_servo, 0.0f);
