...
hal::status application(sjsu::hardware_map& p_map)
{
  ...
  left_steer_motor.velocity_control(5_rpm);
  right_steer_motor.velocity_control(5_rpm);
  back_steer_motor.velocity_control(5_rpm);
  left_hub_motor.velocity_control(5_rpm);
  right_hub_motor.velocity_control(5_rpm);
  back_hub_motor.velocity_control(5_rpm);
